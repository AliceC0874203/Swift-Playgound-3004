//: # Lesson 4 Exercises - Collections
import UIKit

//: ## Array initialization

//: ### Exercise 1
//: 1a) Initialize the array, cuteAnimals. It should be of type String. Type your answer below.
let cuteAnimals: Array<String> = []

//: 1b) Initialize an array of 5 bools using array literal syntax.
let arrayLiteral: [Bool] = [true, false, false, true, true]
